...
// @icon         data:image/png;base64,
// @grant        GM_openInTab
...
function logo() {
    if (GM_getValue("LogoDisplay", 0x7755) == 0x7755) GM_setValue("LogoDisplay", 0);
    if (GM_getValue("LogoDisplay") == 1) {
        GM_addStyle(`
.layout-header_right__oSVlJ::before {
    content: "517Coding Better";
    display: flex;
    font-size: 11px;
    text-align: center;
...
.index_right__7zJFP::before {
    ...
    color: var(--color-text-1);
        ...
        GM_registerMenuCommand("关闭517Coding Better Logo（将自动刷新）", () => {
            GM_setValue("LogoDisplay", 0);
            window.location.reload();
        })
    }
    else {
        GM_registerMenuCommand("开启517Coding Better Logo（将自动刷新）", () => {
            GM_setValue("LogoDisplay", 1);
            window.location.reload();
        })
    }
}
...
.index_title__ZaaoU {
    ...
    .arco-typography::after {
        content: "  /  ";
        white-space: pre;
        font-weight: unset !important;
    }

    .index_header-owner__ScuQN {
        .arco-link {
...
.gotowww {
    ...
    background-color: rgba(233, 243, 255, 0.7);
    box-shadow: 4px 4px 7px hsl(213, 52%, 80%);
}

.gotowww2 {
    backdrop-filter: blur(4px);
    background-color: var(--color-fill-1);
    box-shadow: 2px 2px 7px var(--color-neutral-3);
    font-size: large;
...
.problem_container__tWXAL .arco-row {
    overflow: hidden;
    position: relative;
}

.problem_container__tWXAL .arco-col-20 {
...
.arco-btn.arco-btn-text.arco-btn-size-small.arco-btn-shape-square>.arco-typography>.arco-typography>b>svg {
    /*position: fixed;*/
    transition: 0.1s;
    transition-delay: 0.06s;
    left: 20px;
...
.arco-btn.arco-btn-text.arco-btn-size-small.arco-btn-shape-square>.arco-typography>.arco-typography>b>.arco-spin {
    /*position: fixed;*/
    transition: 0.1s;
    transition-delay: 0.06s;
    left: 20px;
...
.index_sample-test__0H_7y h4 {
    background-color: var(--color-bg-1);
    padding-left: 8px;
}

.console_sample-test__ADC3v {
    display: flex;
    justify-content: space-between;
}

.console_input__cgX9q {
    background-color: var(--color-neutral-2);
    flex: 50%;
    margin-right: 15px;
}

.console_output__WyWLI {
    background-color: var(--color-neutral-2);
    flex: 50%;
    margin-right: 30px;
}

.console_output__WyWLI pre {
    font-family: Consolas;
}

.console_input__cgX9q pre {
    font-family: Consolas;
}
...
function change_test_status(data) {
    ...
    if (data.message.status == "done") {
        myfetch("https://www.517coding.com/api/submissions/" + data.message.sid).then(res => res.json()).then(res => {
            ...
            else if (res.verdict == 6) {
                r.classList.add("arco-typography-warning");
                r.innerText = "时间超限";
            }
            else if (res.verdict == 7) {
                r.classList.add("arco-typography-warning");
                r.innerText = "内存超限";
            }
            else if (res.verdict == 8) {
                r.classList.add("arco-typography-error");
                r.innerText = "运行出错";
            }
            else {
                r.classList.add("arco-typography-secondary");
                r.innerText = "隐藏";
            }
            setTimeout(() => {
...
function for_discuss() {
    $(document).ready(function () {
        var container1 = document.getElementsByClassName("Header-title")[0];
        var div = `
<div class="Header-title">
	<a href="https://www.517coding.com" id="main-link">
		主站
	</a>
</div>`;
        container1.insertAdjacentHTML('afterend', div);
    })
}

function for_no_www_website() {
    $(document).ready(function () {
        var container1 = document.body;
        var div = `
<div id="gotowww" class="gotowww arco-alert arco-alert-info arco-alert-with-title" role="alert" style="bottom:60px; position:fixed; width:fit-content; border-radius: 20px; left: 30px; z-index: 9999;">
	<div class="arco-alert-icon-wrapper">
		<svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="arco-icon arco-icon-info-circle-fill">
			<path fill="currentColor" fill-rule="evenodd" stroke="none" d="M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20Zm2-30a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2Zm0 17h1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h1v-8a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v11Z" clip-rule="evenodd"></path>
		</svg>
	</div>
	<div class="arco-alert-content-wrapper">
		<div class="arco-alert-title">你当前在「517coding.com」上，点击跳转到「www.517coding.com」</div>
	</div>
</div>`;
        container1.insertAdjacentHTML('beforeend', div);
        var btn = document.getElementById("gotowww");
        btn.onclick = function () {
            ...
            window.location.href = "https://www.517coding.com/" + url.substring(22, url.length);
        }
    })
}

function for_training() {
...
function fun() {
    ...
    console.log("517Coding better loaded successfully");
}
